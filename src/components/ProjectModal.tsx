...
export interface ProjectData {
  ...
  // ✅ add this flag (same as your cards list)
...
const ProjectModal = ({ project, onClose }: ProjectModalProps) => {
  ...
  const showLiveSite = !!project.siteLink && !project.hideProjectButton;
          ...
          <div className="mb-4">
            ...
            <div
              className={`grid gap-3 ${
                showLiveSite ? "sm:grid-cols-2" : "sm:grid-cols-1"
              }`}
            >
              {/* ✅ Live Site shown only if allowed */}
              {showLiveSite && (
                <a
                  href={project.siteLink}
                  target="_blank"
